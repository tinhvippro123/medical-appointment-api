        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxPatients = table.Column<int>(type: "int", nullable: false, defaultValue: 20),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_PatientProfiles_PatientProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_PatientProfiles_PatientProfileId",
                        column: x => x.PatientProfileId,
                        principalTable: "PatientProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ADMIN", "Toàn quyền hệ thống", "Quản trị viên", null },
                    { 2, "PATIENT", "Người dùng đặt lịch", "Bệnh nhân", null }
                });

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_DoctorId",
                table: "CartItems",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_PatientProfileId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_PatientProfileId",
                table: "OrderDetails",
                column: "PatientProfileId");
